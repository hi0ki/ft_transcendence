...
// ── Banner gradient (seeded by username) ─────────────────────
...
function ProfilePage() {
    ...
    // Profile state (can be replaced by API data later)
    const [profile, setProfile] = useState({
        fullName: (username || derivedUsername).charAt(0).toUpperCase() + (username || derivedUsername).slice(1),
    ...
    // Dynamic isOwner logic: owner if no username in URL or if it matches current user
    const isOwner = !username || username === derivedUsername;

    const bannerSeed = username || derivedUsername;
    const bannerGradient = getBannerGradient(bannerSeed);
                ...
                <div className="profile-card">
                    ...
                    <div className="profile-info-row">
                        <div className="profile-meta">
                            ...
                            <p className="profile-handle">@{profile.username.toLowerCase().replace(/\s+/g, '')}</p>
                            ...
                            <div key={post.id} className="post-card">
                                <div className="post-header">
                                    ...
                                    <div className="post-author-info">
                                        <span className="post-author-name">{profile.fullName}</span>
